package com.example.webproject.mailgun;
...
public class MailgunService {
    ...
    private static final String DOMAIN = "sandbox600c075fa1bc4cc3821bdd52f3e2db87.mailgun.org";

    public static void sendMail(String subject, String body, String recipients) {
        try {
            List<NameValuePair> form = new ArrayList<>();
            form.add(new BasicNameValuePair("from", "vcneykov@gmail.com"));
    ...
    private static CredentialsProvider getAuthProvider() {
        ...
        UsernamePasswordCredentials credentials
                ...
                "22d19ec79a76f541a1b7e3a246b3736b-4f207195-b992819f");
